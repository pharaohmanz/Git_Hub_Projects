...
<title>easyBuy Accessories</title>
...
<center>
	...
	<table>
		<tr>
		<td><font color="#008CBA"><h2>Tablet Accessories</font></h2></td>
		</tr>
		<table>
		<tr>
			<td>
			<b>Apple Ipad Air2 Tablet Case</b><br>
			<img src="images/tab_acc.png" width="100" height="100">Price: $14.00<br>
			<input type="button" value="Add to Cart">
			</td>
		<td colspan="50"></td>
			<td>
			<b>Apple Ipad Pro Leather Case</b><br>
			<img src="images/tab_case_2.jpg" width="100" height="100">Price: $9.99<br>
			<input type="button" value="Add to Cart">
			</td>
		</tr>
		</table>
		...
		<tr>
			<td>
			<b>Samsung Tablet Case</b><br>
			<img src="images/tab_case_1.jpg" width="100" height="100">Price: $10.00<br>
			<input type="button" value="Add to Cart">
			</td>
		<td colspan="50"></td>
			<td>
			<b>Samsung Universal Leather Leather Case</b><br>
			<img src="images/tab_case_4.jpg" width="100" height="100">Price: $5.99<br>
			<input type="button" value="Add to Cart">
			</td>
		</tr>
		</table>
		...
		<tr>
			<td>
			<b>Asus Pro Sleek Leather Case</b><br>
			<img src="images/tab_case_3.jpg" width="100" height="100">Price: $9.99<br>
			<input type="button" value="Add to Cart">
			</td>
			<td colspan="50"></td>
			<td>
			<b>Asus Tablet Cover</b><br>
			<img src="images/tab_case_5.jpg" width="100" height="100">Price: $20.00<br>
			<input type="button" value="Add to Cart">
			</td>
		</tr>
		</table>
