...
<title>easyBuy Notification</title>
...
<center>
<h2>easyBuy Notifications</h2>
<div class="noborder">
<form>
<label style="float:left;"><b>Email Address:</b></label><br>
<input type="text" name="email" id="email">
<input type="radio" name="subscribe1" value="Subscribe"> Subscribe
<input type="radio" name="subscribe1" value="Unsubscribe"> Unsubscribe<br>
<br>
<label style="float:left;"><b>Mobile Alert:</b></label><br> 
<input type="text" name="mobile" id="mobile">
<input type="radio" name="subscribe2" value="Subscribe"> Subscribe
<input type="radio" name="subscribe2" value="Unsubscribe"> Unsubscribe<br>
Receive 1 msg/day. Msg & Data Rates May Apply.<br>
<br>
