...
<center>
	...
	<table>
		<tr>
		<td><font color="#008CBA"><h2>Cell Phone Accessories</font></h2></td>
		</tr>
		<table>
		<tr>
			<td>
			<b>Samsung Galaxy S6 Cases in<br> Different Colors</b><br>
			<img src="images/cell_acc.jpg" width="100" height="100">Price: $12.99<br>
			<input type="button" value="Add to Cart">
			</td>
		<td colspan="50"></td>
			<td>
			<b>Samsung Galaxy S6 case</b><br>
			<img src="images/cell_case_1.jpg" width="100" height="100">Price: $6.99<br>
			<input type="button" value="Add to Cart">
			</td>
		</tr>
		</table>
		...
		<tr>
			<td>
			<b>iphone 6s Case</b><br>
			<img src="images/cell_case_2.jpg" width="100" height="100">Price: $6.00<br>
			<input type="button" value="Add to Cart">
			</td>
		<td colspan="50"></td>
			<td>
			<b>iphone 6s Plus Case</b><br>
			<img src="images/cell_case_3.jpg" width="100" height="100">Price: $11.99<br>
			<input type="button" value="Add to Cart">
			</td>
		</tr>
		</table>
